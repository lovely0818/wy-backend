...
from dvadmin.system.views.jira import JiraViewSet
...
system_url.register(r'jira_project', JiraViewSet)
system_url.register(r'jira', JiraViewSet)
urlpatterns = [
